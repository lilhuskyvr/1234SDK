...
namespace VRMShaders
{
    ...
    public class MaterialFactory : IResponsibilityForDestroyObjects
    {
            ...
            IAwaitCaller awaitCaller)
        {
            ...
            var shaderName = "SimpleURPToonLitExample(With Outline)"; //item.shader;
            ...
            {
                material.renderQueue = (int)UnityEngine.Rendering.RenderQueue.GeometryLast < matDesc.RenderQueue.Value
                    ? (int)UnityEngine.Rendering.RenderQueue.GeometryLast
                    : matDesc.RenderQueue.Value;
            }
        ...
        public static void SetTextureOffsetAndScale(Material material, string propertyName, Vector2 offset,
            Vector2 scale)
        {
